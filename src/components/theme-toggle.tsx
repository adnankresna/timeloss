...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="theme-toggle-btn relative overflow-hidden bg-background bg-opacity-40 backdrop-blur-md dark:bg-background dark:bg-opacity-30 ring-0 border-0"
    >
